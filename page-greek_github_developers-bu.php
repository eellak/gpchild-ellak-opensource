	...
	<div id="primary" <?php generate_content_class();?>>
		<main id="main" <?php generate_main_class(); ?> itemprop="mainContentOfPage" role="main">
			<?php do_action('generate_before_main_content'); ?>
                        <?php
                        $list_of_developers[]; //associative array of developers with number of contrbutions
                        
                        //access the file with the list of the developer logins and the contributions total
                        if(file_exists(wp_upload_dir().'ellak_github_developers/orgs/sum_contr.txt')){
                            $sum_contr=fopen(wp_upload_dir().'ellak_github_developers/orgs/sum_contr.txt');
