...
function enqueue_bootstrap(){
    //the css file
    wp_enqueue_style('bootstrap_css_3.3', get_stylesheet_directory_uri().'/css/bootstrap.min.css');
...
/**
 * Enqueue the style file for the github contributor archive page
 **/
if(!function_exists('archive_github_contributor_style')){
    function archive_github_contributor_style(){
        //if(is_page_template('archive-github_contributor.php')){
            wp_enqueue_style('archive-github_contributor-style', get_stylesheet_directory_uri().'/css/archive-github_contributor-style.css', array('bootstrap_css_3.3'));
        //}
        wp_enqueue_script('github_contributors-js', get_stylesheet_directory_uri().'/js/github_contributors.js', array('jquery'));
    }
}
add_action('wp_enqueue_scripts', 'archive_github_contributor_style');
